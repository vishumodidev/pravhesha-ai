...
const initialUsers: UserRecord[] = [
  { id: '1', name: 'Rahul Sharma', email: 'rahul.sharma@email.com', role: 'Admin', department: 'Sales', status: 'Active', lastLogin: 'May 21, 2024 10:30 AM', joinedOn: 'Apr 12, 2024', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=150' },
  { id: '2', name: 'Priya Mehta', email: 'priya.mehta@email.com', role: 'Team Lead', department: 'Sales', status: 'Active', lastLogin: 'May 21, 2024 09:45 AM', joinedOn: 'Apr 15, 2024', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=150' },
  { id: '3', name: 'Amit Verma', email: 'amit.verma@email.com', role: 'Support Manager', department: 'Support', status: 'Active', lastLogin: 'May 21, 2024 08:50 AM', joinedOn: 'Apr 18, 2024', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=150' },
  { id: '4', name: 'Sneha Iyer', email: 'sneha.iyer@email.com', role: 'Support Agent', department: 'Support', status: 'Active', lastLogin: 'May 21, 2024 10:12 AM', joinedOn: 'Apr 20, 2024', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=150' },
  { id: '5', name: 'Dinesh Kumar', email: 'dinesh.kumar@email.com', role: 'Sales Executive', department: 'Sales', status: 'Active', lastLogin: 'May 21, 2024 09:10 AM', joinedOn: 'May 02, 2024', avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?q=80&w=150' },
  { id: '6', name: 'Neha Patel', email: 'neha.patel@email.com', role: 'Sales Executive', department: 'Sales', status: 'Inactive', lastLogin: 'May 19, 2024 04:30 PM', joinedOn: 'Apr 25, 2024', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=150' },
  { id: '7', name: 'Manish Jain', email: 'manish.jain@email.com', role: 'Marketing Executive', department: 'Marketing', status: 'Active', lastLogin: 'May 21, 2024 11:05 AM', joinedOn: 'May 01, 2024', avatar: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?q=80&w=150' },
  { id: '8', name: 'Rohit Gupta', email: 'rohit.gupta@email.com', role: 'Sales Executive', department: 'Sales', status: 'Invited', lastLogin: '—', joinedOn: 'May 21, 2024', avatar: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?q=80&w=150' }
];

const roleDistributionData = [
  { name: 'Admin', value: 2, color: '#8b5cf6' },
  { name: 'Team Lead', value: 3, color: '#3b82f6' },
  { name: 'Support Manager', value: 2, color: '#10b981' },
  { name: 'Support Agent', value: 8, color: '#06b6d4' },
  { name: 'Sales Executive', value: 9, color: '#f59e0b' },
  { name: 'Marketing Exec', value: 4, color: '#ec4899' }
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        {[
          { title: 'Total Users', val: '28', pct: '+12.5%' },
          { title: 'Active Users', val: '24', pct: '+9.1%' },
          { title: 'Inactive Users', val: '4', pct: '-20.0%', negative: true },
          { title: 'Pending Invites', val: '3', pct: '+50.0%' },
          ...
          <div key={idx} className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
            ...
            <div className="flex items-baseline justify-between mt-2">
              ...
              <span className={`text-[9px] font-bold block mt-1 ${
                item.negative ? 'text-rose-500' : 'text-emerald-605'
              }`}>{item.pct}</span>
            </div>
          </div>
        ))}
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredUsers.map((u) => (
                  <tr key={u.id} className="hover:bg-slate-50 group">
                    ...
                    <td className="py-3">
                      <span className={`px-2.5 py-0.5 text-[9.5px] rounded border font-bold ${getRoleBadgeColor(u.role)}`}>
                        {u.role}
                      </span>
                    </td>
                    ...
                    <td className="py-3 text-slate-400">{u.joinedOn}</td>
                    <td className="py-3 text-right">
                      <div className="flex items-center justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="p-1 text-slate-400 hover:text-slate-700 hover:bg-slate-100 rounded">
                          <Edit size={12} />
                        </button>
                        <button
        ...
        <div className="w-full lg:w-80 space-y-6 shrink-0">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
            <h3 className="font-bold text-slate-800 text-sm mb-4 m-0">Role Distribution</h3>
            <div className="flex gap-4 items-center justify-center my-2">
              <div className="relative w-28 h-28 shrink-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <span className="text-sm font-extrabold text-slate-800 leading-none">28</span>
              ...
              <div className="space-y-1 text-[8.5px] font-medium leading-tight">
                {roleDistributionData.slice(0, 4).map((entry, i) => (
                  <div key={i} className="flex items-center gap-1">
                    ...
                    <span className="text-slate-650 truncate max-w-[70px]">{entry.name}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-slate-800 text-sm m-0">Roles & Permissions</h3>
              <button className="text-[10px] text-indigo-600 font-bold hover:underline">Manage</button>
            </div>
            <div className="space-y-3 text-[11px] text-slate-500">
              {[
                ...
                <div key={i} className="flex justify-between items-start pb-2 border-b border-slate-50 last:border-none">
                  <div>
                    <span className="font-bold text-slate-800 block leading-tight">{r.role}</span>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-bold text-slate-800 text-sm m-0">Recent Activity</h3>
                ...
                <div key={i} className="flex gap-2.5 items-start">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-slate-650 leading-normal text-[11px]">
                      <strong className="text-slate-800">{act.name}</strong> {act.action}
                    </p>
                    <span className="text-[9.5px] text-slate-400 block mt-0.5">{act.time}</span>
                  </div>
                </div>
              ))}
            </div>
