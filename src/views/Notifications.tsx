      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-baseline leading-none">
                    <h4 className="text-xs font-bold text-slate-800 m-0">{n.title}</h4>
                    <span className="text-[10px] text-slate-400">{n.time}</span>
                  </div>
                  <p className="text-slate-500 mt-1 text-[11px] font-medium leading-relaxed">{n.desc}</p>
        ...
        <div className="w-full lg:w-80 space-y-6 shrink-0">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
            <h3 className="font-bold text-slate-800 text-sm m-0">Notification Summary</h3>
            <div className="grid grid-cols-2 gap-3 text-xs">
              {[
                { title: 'Total Alerts', val: '128', change: '▲ 18.6%' },
                { title: 'Unread', val: '8', change: '▼ 11.5%', negative: true },
                ...
                <div key={i} className="bg-slate-50 border border-slate-100 rounded-xl p-3 flex flex-col justify-between">
                  ...
                  <span className="text-lg font-bold text-slate-800 mt-2 block">{item.val}</span>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="font-bold text-slate-800 text-sm m-0">Preferences</h3>
            ...
            <div className="space-y-3.5 text-xs">
              {[
                ...
                <div key={i} className="flex justify-between items-center pb-2 border-b border-slate-50 last:border-none">
                  <div>
                    <span className="font-bold text-slate-700 block leading-tight">{pref.label}</span>
                    <span className="text-[9.5px] text-slate-400 block mt-0.5">{pref.freq}</span>
                  </div>
                  {/* Mock Toggle */}
