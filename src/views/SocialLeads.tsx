    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">X (Twitter) Leads</span>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">Total Social Leads</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div>
            <h3 className="font-bold text-slate-800 text-sm m-0">Leads by Platform</h3>
            <p className="text-[11px] text-slate-400">Leads distribution by channel</p>
          </div>
          <div className="flex gap-4 items-center justify-center my-2">
            <div className="relative w-28 h-28 shrink-0">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-sm font-extrabold text-slate-800 leading-none">680</span>
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-bold text-slate-800 text-sm m-0">Leads Trend</h3>
              <p className="text-[11px] text-slate-400">Leads generated over 7 days</p>
            </div>
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div>
            <h3 className="font-bold text-slate-800 text-sm m-0">Lead Source Attribution</h3>
            <p className="text-[11px] text-slate-400">Which sources convert best</p>
          </div>
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-bold text-slate-800 text-sm m-0">Social Inbox</h3>
            <span className="text-[9px] bg-indigo-50 text-indigo-600 font-bold px-2 py-0.5 rounded-full">All</span>
          </div>

          <div className="space-y-3 overflow-y-auto max-h-[170px] flex-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div className="flex flex-wrap gap-1 bg-slate-50 p-1 rounded-xl">
              {[
                { id: 'all', label: 'All Leads', count: 680 },
                { id: 'new', label: 'New', count: 128 },
                { id: 'engaged', label: 'Engaged', count: 212 },
                { id: 'qualified', label: 'Qualified', count: 158 }
              ].map((tab) => (
                <button
                  key={tab.id}
            ...
            <table className="w-full text-xs text-left">
              <thead>
                <tr className="text-slate-400 border-b border-slate-100">
                  ...
                  <th className="pb-2 font-semibold">Campaign / Post</th>
                  <th className="pb-2 font-semibold">Lead Info</th>
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredSocialLeads.map((l) => (
                  <tr key={l.id} className="hover:bg-slate-50 group">
                    ...
                    <td className="py-3 text-slate-500">{l.campaign}</td>
                    <td className="py-3">
                      <span className="text-slate-800 font-bold block">{l.phone}</span>
                      <span className="text-[10px] text-slate-400 block">{l.location}</span>
                    </td>
                    <td className="py-3">
                      <span className={`font-bold ${l.aiScore >= 80 ? 'text-rose-500' : 'text-slate-700'}`}>{l.aiScore}</span>
                    </td>
                    <td className="py-3">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
            ...
            <div className="space-y-3.5">
              ...
              <div className="flex gap-2 items-start text-xs bg-slate-50 border border-slate-100 p-2.5 rounded-xl">
                <span className="text-indigo-600 font-bold">•</span>
                <p className="text-slate-600 leading-normal">
                  The campaign <strong className="text-indigo-600">FB - Summer Offer Campaign</strong> leads in volume (142 leads).
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Top campaigns */}
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
            <h3 className="font-bold text-slate-800 text-sm mb-4 m-0">Top Campaigns</h3>
              ...
              {[
                ...
                <div key={i} className="space-y-1.5">
                  <div className="flex justify-between items-baseline leading-none font-medium">
                    <span className="text-slate-600 truncate max-w-[170px]">{campaign.name}</span>
