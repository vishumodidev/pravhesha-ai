...
export default function VisitorIntelligencePage() {
  ...
  const [selectedLead, setSelectedLead] = useState<VisitorLead | null>(initialVisitorLeads[0]);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block text-left">Total Visitors</span>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block text-left">Unique Visitors</span>
          <div className="flex items-baseline justify-between mt-2">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block text-left">Visitor Leads</span>
          <div className="flex items-baseline justify-between mt-2">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block text-left">Hot Visitors</span>
          <div className="flex items-baseline justify-between mt-2">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block text-left">Returning Visitors</span>
          <div className="flex items-baseline justify-between mt-2">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block text-left">Visitor Lead Conv.</span>
          <div className="flex items-baseline justify-between mt-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div>
            <h3 className="font-bold text-slate-800 text-sm mb-4 m-0 text-left">Visitor Leads Summary</h3>
            <div className="space-y-3.5">
              {[
                ...
                <div key={idx} className="flex justify-between items-center text-xs pb-2.5 border-b border-slate-50 last:border-none">
                  ...
                  <span className="font-bold text-slate-808">{row.val}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="pt-2 flex justify-between items-center text-xs border-t border-slate-100 mt-2">
            ...
            <span className="font-extrabold text-emerald-605">3.49%</span>
          </div>
        </div>
        ...
        <div className="lg:col-span-4 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="font-bold text-slate-800 text-sm m-0 text-left">Visitor Leads Trend</h3>
              <p className="text-[11px] text-slate-400 text-left">Daily conversion rates</p>
            </div>
          ...
          <div className="flex items-center justify-center gap-4 mt-2 text-[10px]">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-slate-555 font-medium">New Leads</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-emerald-500" />
              <span className="text-slate-555 font-medium">Converted Leads</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-[11px] text-slate-400 text-left">Leads acquisition distribution</p>
          </div>
          <div className="flex gap-4 items-center justify-center my-1">
            <div className="relative w-24 h-24 shrink-0">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-xs font-extrabold text-slate-808 leading-none">312</span>
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <h3 className="font-bold text-slate-800 text-sm mb-3 m-0 text-left">Top Pages</h3>
            ...
            <table className="w-full text-xs text-left">
              <thead>
                <tr className="text-slate-400 border-b border-slate-100">
                  ...
                  <th className="pb-2 font-semibold text-left">Landing Page</th>
                  <th className="pb-2 font-semibold text-left">First Seen</th>
                  <th className="pb-2 font-semibold text-left">Last Seen</th>
                  <th className="pb-2 font-semibold text-left">AI Score</th>
                  <th className="pb-2 font-semibold text-left">Intent</th>
              ...
              <tbody className="divide-y divide-slate-50">
                {filteredVisitorLeads.map((v) => {
                  ...
                  return (
                    ...
                    >
                      <td className="py-3">
                        <span className="text-slate-800 font-bold block text-left">{v.name}</span>
                        <span className="text-[10px] text-slate-400 block text-left">{v.email}</span>
                      </td>
                      <td className="py-3 text-slate-600 text-left">{v.source}</td>
                      <td className="py-3 text-slate-605 font-mono text-[10.5px] text-left">{v.landingPage}</td>
                      <td className="py-3 text-slate-404 text-left">{v.firstSeen}</td>
                      <td className="py-3 text-slate-505 font-medium text-left">{v.lastSeen}</td>
                      <td className="py-3 text-left">
                        <span className="font-bold text-slate-808">{v.aiScore}</span>
                      </td>
                      <td className="py-3 text-left">
                      ...
                      <td className="py-3 text-left">
                        <span className={`px-2 py-0.5 text-[9px] rounded font-bold ${
                          v.status === 'New Lead' ? 'bg-indigo-50 text-indigo-606' : 'bg-emerald-50 text-emerald-606'
                        }`}>
                          {v.status}
                        </span>
                      </td>
        ...
        {selectedLead && (
          <div className="w-full lg:w-80 bg-white border border-slate-200 rounded-2xl shadow-sm flex flex-col shrink-0 overflow-hidden">
            ...
            <div className="p-4 border-b border-slate-50 flex flex-col items-center text-center">
              ...
              <h3 className="font-bold text-slate-808 text-sm m-0">{selectedLead.name}</h3>
            ...
            <div className="flex border-b border-slate-100 bg-slate-50/50">
              <button
                ...
                className={`flex-1 py-1.5 text-center text-xs font-bold border-b-2 ${
                  sidebarTab === 'overview' ? 'border-indigo-600 text-indigo-650' : 'border-transparent text-slate-405'
                }`}
              >
                Overview
              </button>
              <button
                ...
                className={`flex-1 py-1.5 text-center text-xs font-bold border-b-2 ${
                  sidebarTab === 'journey' ? 'border-indigo-600 text-indigo-655' : 'border-transparent text-slate-405'
                }`}
              >
                Journey
              </button>
            ...
            <div className="p-4 flex-1 space-y-4 max-h-[300px] overflow-y-auto">
              {sidebarTab === 'overview' && (
                <div className="space-y-4 text-xs">
                  ...
                  <div className="space-y-2">
                    <span className="font-bold text-slate-800 block text-left">Lead Information</span>
                    <div className="grid grid-cols-2 gap-2 text-[10.5px] text-left">
                      <span className="text-slate-400">Source:</span>
                      <span className="font-semibold text-slate-707 text-right">{selectedLead.source}</span>
                      <span className="text-slate-400">Landing Page:</span>
                      <span className="font-semibold text-slate-707 text-right font-mono text-[9px] truncate">{selectedLead.landingPage}</span>
                      <span className="text-slate-400">Device:</span>
                      <span className="font-semibold text-slate-707 text-right truncate">{selectedLead.device}</span>
                      <span className="text-slate-400">Pages Visited:</span>
                      <span className="font-semibold text-slate-707 text-right">{selectedLead.pagesVisited}</span>
                      <span className="text-slate-400">Time on Site:</span>
                      <span className="font-semibold text-slate-707 text-right">{selectedLead.timeOnSite}</span>
                      <span className="text-slate-400">Returning Visitor:</span>
                      <span className="font-semibold text-slate-707 text-right">{selectedLead.returningVisits > 1 ? `Yes (${selectedLead.returningVisits} visits)` : 'No'}</span>
                    </div>
                  </div>
                  ...
                  <div className="pt-2 border-t border-slate-100 space-y-2 text-left">
                    <span className="font-bold text-slate-808 block">Recommended Action</span>
              ...
              {sidebarTab === 'journey' && (
                <div className="space-y-3 text-xs pl-2 text-left">
                  <span className="font-bold text-slate-808 block -ml-2 mb-2">Visitor Journey</span>
                  {[
                    ...
                    <div key={i} className="relative pl-5 border-l border-indigo-100 pb-3 last:pb-0">
                      ...
                      <div className="flex justify-between leading-tight">
                        <span className="font-bold text-slate-707 block text-[11px]">{j.title}</span>
